		...
		if($Standard==2){
			$standard_title_primary = get_field( "standard_title_primary_2", $post_id );
			$standard_sub_title = get_field( "standard_sub_title_2", $post_id );
			$standard_text_1 = get_field( "standard_text_1_2", $post_id );
			//$standard_text_2 = get_field( "standard_text_2_2", $post_id );
			//$standard_text_3 = get_field( "standard_text_3_2", $post_id );
			//$standard_text_4 = get_field( "standard_text_4_2", $post_id );
			$standard_button_text_1 = get_field( "standard_button_text_1_2", $post_id );
			$standard_button_text_2 = get_field( "standard_button_text_2_2", $post_id );
			$standard_button_link_1 = get_field( "standard_button_link_1_2", $post_id );
			$standard_button_link_2 = get_field( "standard_button_link_2_2", $post_id );
			$standard_subtitle_first = get_field( "standard_subtitle_first_2", $post_id );
			$standard_section_image = get_field( "standard_section_image_2", $post_id );
			$image_alignment = get_field( "standard_section_image_alignment_2", $post_id );

		} else {
			$standard_title_primary = get_field( "standard_title_primary", $post_id );
			$standard_sub_title = get_field( "standard_sub_title", $post_id );
			$standard_text_1 = get_field( "standard_text_1", $post_id );
			//$standard_text_2 = get_field( "standard_text_2", $post_id );
			//$standard_text_3 = get_field( "standard_text_3", $post_id );
			//$standard_text_4 = get_field( "standard_text_4", $post_id );
			$standard_button_text_1 = get_field( "standard_button_text_1", $post_id );
			$standard_button_text_2 = get_field( "standard_button_text_2", $post_id );
			$standard_button_link_1 = get_field( "standard_button_link_1", $post_id );
			$standard_button_link_2 = get_field( "standard_button_link_2", $post_id );
			$standard_subtitle_first = get_field( "standard_subtitle_first", $post_id );
			$standard_section_image = get_field( "standard_section_image", $post_id );
			$image_alignment = get_field( "standard_section_image_alignment", $post_id );
		}
                           ...
                           <div class="content-grid-item content-grid-item--2-col">
                                <div class="column-content">
                                    <div class="column-content-item">
										...
										print "<!--  ***standard_subtitle_first $standard_subtitle_first                      -->";
										?>
											...
											if($standard_subtitle_first=="no"){
												...
												?>
												<h2 class="standard-title primary"><?php echo $standard_title_primary ?></h2>
												<?php
												}
												?>
												<?php
											...
											if(!empty($standard_text_1)){
												...
												?>															
											   <div class="standard-text"><p class="standard-copy"><?php echo $standard_text_1 ?></p></div>	
												<?php
											}
											?>	
                                        ...
                                        <?php
										$link_button_to_enquiry_form_1 = get_field('link_button_to_enquiry_form_1', $post_id);
										$link_button_to_enquiry_form_2 = get_field('link_button_to_enquiry_form_2', $post_id);
										
										$css_1="";
										$css_2="";
										
										if(!empty($link_button_to_enquiry_form_1)){
											if($link_button_to_enquiry_form_1[0]=='yes'){
												 $standard_button_link_1="#";
												 $css_1="pop-up-trigger";
											}
										}
										if(!empty($link_button_to_enquiry_form_2)){
											if($link_button_to_enquiry_form_2[0]=='yes'){
										...
										print "<!-- :::   \n \n  ";
										print_r($link_button_to_enquiry_form_1);
										print "   \n \n ";
										print_r($link_button_to_enquiry_form_2);
										print "   \n \n	-->";
										print "<!-- ::: css_1=$css_1  :::    css_2=$css_2      -->";
										...
										if(!empty($button_group) || !empty($standard_button_text_2)){
											...
											<div class="button-group primary">
													...
													<a href="<?php echo $standard_button_link_2 ?>" class="button ghost <?php echo $css_2 ?>"><?php echo $standard_button_text_2 ?></a>
											</div>
											<?php
										} else {
