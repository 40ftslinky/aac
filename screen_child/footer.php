                ...
                <div class="row">
                    <div class="column">
                        <div class="footer_form">
                            <form class="dark-form inline" action="#" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="subscribe_email" name="email" placeholder="To stay updated" required>
                                    <div id="error" class="error-msg visually-hidden">Error Message visible.</div>
                                </div>                                

                                <button type="submit" class="button-medium outline pop-up-trigger pop-up-subscribe">Subscribe</button>
                            </form>
                        </div>
                        ...
                        <div class="footer_social">
                            <a class="footer_link" href="https://www.facebook.com/AustralianAgriculturalCentre" target="_blank" rel="noopener noreferrer">
                            ...
                            <a class="footer_link" href="https://www.instagram.com/australianagriculturalcentre" target="_blank" rel="noopener noreferrer">
                            ...
                            <a class="footer_link" href="https://www.linkedin.com/company/australian-agricultural-centre/" target="_blank" rel="noopener noreferrer">
